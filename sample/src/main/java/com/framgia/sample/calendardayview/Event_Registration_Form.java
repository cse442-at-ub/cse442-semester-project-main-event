...
import com.framgia.library.calendardayview.R;

/**
 * TODO: document your custom view class.
 */
public class Event_Registration_Form extends View {
    ...
    public Event_Registration_Form(Context context) {
        super(context);
        init(null, 0);
    }

    public Event_Registration_Form(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public Event_Registration_Form(Context context, AttributeSet attrs, int defStyle) {
